        ...
        <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="option-inner">
                    <div class="others-options d-flex align-items-center">
                        <div class="option-item">
                            <a href="login.jsp" class="default-btn">Connectez-Vous</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="ajout_client.jsp" class="nav-link">
                            Ajout de client
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="list_client.jsp" class="nav-link">
                            Listes des Clients
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="ajout_agent.jsp" class="nav-link">
                            Ajout Agent
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="list_agent.jsp" class="nav-link">
                            Listes des Agents
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="ajout_agence.jsp" class="nav-link">
                            Ajout Agence
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="list_agence.jsp" class="nav-link">
                            Listes des Agences
                        </a>
                    </li>
                ...
                <div class="others-options d-flex align-items-center">
                    <div class="option-item">
                        ...
                        <a href="#" class="default-btn">welcome </a>
                    </div>
                </div>
            </div>
        </nav>
