            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="main-banner-content">
                        ...
                        <p>Votre transfert de compte est facilitÃ©, changement de vie ou de rÃ©gion, votre Banque Aaskanbi vous accompagne et facilite votre dÃ©marche. </p>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="grow-content">
                    ...
                    <p>Acteur clÃ© de lâÃ©conomie rÃ©gionale, Banque Aaskanbi sâest fixÃ©e pour objectif dâaccompagner tout ceux qui entreprennent sur le chemin de la rÃ©ussite. <br>Banque Aaskanbi, elle est la propriÃ©tÃ© de ses clients. <br><br>Sâengager au service des projets personnels et professionnels de ses clients et sociÃ©taires, et les accompagner dans la durÃ©e, tel est lâesprit Banque Aaskanbi.
                    Un conseiller a lâÃ©coute de vos besoins.<br>
                    <br><br>Chez Banque AasKanbi, tous les clients bÃ©nÃ©ficient dâun conseiller dÃ©dier. <br>EpaulÃ© par un rÃ©seau dâexperts il vous connait et est Ã  votre disposition pour vous accompagner dans tous vos projets.
                    </p>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="operate-content">
                    <span>AaskanBi_Bank</span>
                    <h2>Ouvrir un compte : les documents Ã  communiquer </h2>
                    <h3>En vue de lâouverture des comptes, vous devez notamment transmettre les principaux documents :</h3>
                    <p>Une piÃ¨ce en cours de validitÃ©s (carte dâidentitÃ©, passeport ou titre de sÃ©jours).
                    <br>Un justificatif de domicile de moins de trois mois.
                    <br>Un justificatif dâactivitÃ© (avis dâimposition, carte dâÃ©tudiantâ¦).
                    <br>Dâautres documents avec une date rÃ©cente, peuvent vous Ãªtre demandÃ© en fonction de votre situation personnelle et professionnelle
                    </p>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-footer-widget">
                            <div class="footer-logo">
                                ...
                                <p>EpaulÃ© par un rÃ©seau dâexperts il vous connait et est Ã  votre disposition pour vous accompagner dans tous vos projets.</p>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-contact-info">
                                ...
                                <li>
                                    <i class='bx bx-map'></i>
                                    <span>Address</span>
                                    Rue 09 Angle 14, Medina Fass guÃ©l tapÃ©, DAKAR-SENEGAL
                                </li>
                            </ul>
                        </div>
                    </div>
