                 ...
                 <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="username" class="form-control" placeholder="Numéro de compte" required="required">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="compte2" class="form-control" placeholder="Numéro de compte" required="required">
                        </div>
                    </div>
                    <div class="col-lg-12">
