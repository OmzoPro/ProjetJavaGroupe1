    ...
    <div class="container">
        ...
        <div class="open-account-form">
            <form action="<%=request.getContextPath()%>/Virement" method="post">
                 <%
           Compte c = (Compte) session.getAttribute("sessionVirement");
           %>
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                     ...
                     <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" disabled="" value=" <%=c.getTypeCompte() %>" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            <label>Solde du compte</label>
                            <input type="text"   name="soldeAvant"  value="50000" class="form-control">
                        </div>
                    </div>
                                            <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                         ...
                         <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="compteDestinataire" value="" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
